import random
import os
#C:\Users\USUARIO\OneDrive\COMPARTIR LENOVO\Platzi curso\python_intermedio_project\JuegoAhorcado.py
def data_read(filepath):
    dat1 = []
    with open("./archivos/data.txt", "r", encoding="utf-8") as f: 
        for datline in f:
            dat1.append(datline.strip().upper() )
    return(dat1)

def run():
    data = data_read(filepath="./archivos/data.txt")
